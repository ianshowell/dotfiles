...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'c++-mode-hook
            (function (lambda ()
                        (local-set-key (kbd "<f3> u") 'stampede-compile-unit-tests)
                        (local-set-key (kbd "<f3> d") 'stampede-compile-debug)
                        (local-set-key (kbd "<f3> r") 'stampede-compile-balanced)
                        (local-set-key (kbd "<f3> i") 'stampede-compile-func-interactive)
                        (local-set-key (kbd "<f3> c") 'clean-all))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
    ...
    (add-hook 'c++-mode-hook
              (function (lambda ()
                          (local-set-key (kbd "<f4> u") 'stardust-compile-unit-tests)
                          (local-set-key (kbd "<f4> d") 'stardust-compile-debug)
                          (local-set-key (kbd "<f4> r") 'stardust-compile-balanced)
                          (local-set-key (kbd "<f4> i") 'stardust-compile-func-interactive)
                          (local-set-key (kbd "<f4> c") 'stardust-clean-all))))
#+END_SRC
*** C/C++ Compilation Defuns for Blackhole
#+BEGIN_SRC emacs-lisp
    (defun blackhole-compile-func-interactive ()
      (compile-func-interactive "Blackhole" "balanced" "11"))

    (defun blackhole-compile-balanced ()
      "Compiles blackhole in release mode."
      (interactive)
      (compile-func "Blackhole" "balanced" "11"))

    (defun blackhole-compile-unit-tests ()
      "Compiles unit tests."
      (interactive)
      (compile-func "BlackholeUnitTests" "debug" "11")
      (compile-func "BlackholeIntegrationTests" "debug" "11"))

    (defun blackhole-compile-debug ()
      "Compiles unit tests."
      (interactive)
      (compile-func "Blackhole" "debug" "11"))

    (defun blackhole-clean-all ()
      "Runs make clean in the specified directory"
      (interactive)
      (if (yes-or-no-p "Are you sure you want to clean all?")
          (progn
    ...
    (add-hook 'c++-mode-hook
              (function (lambda ()
                          (local-set-key (kbd "<f5> u") 'blackhole-compile-unit-tests)
                          (local-set-key (kbd "<f5> d") 'blackhole-compile-debug)
                          (local-set-key (kbd "<f5> r") 'blackhole-compile-balanced)
                          (local-set-key (kbd "<f5> i") 'blackhole-compile-func-interactive)
                          (local-set-key (kbd "<f5> c") 'blackhole-clean-all))))
#+END_SRC
