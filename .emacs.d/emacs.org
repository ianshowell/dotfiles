...
#+BEGIN_SRC emacs-lisp
  ...
  (defun stampede-compile-tests ()
    "Compiles unit tests."
    (interactive)
    (compile-func "StampedeUnitTests" "debug" "11")
    (compile-func "StampedeIntegrationTests" "debug" "11"))
  ...
  (add-hook 'c++-mode-hook
            (function (lambda ()
                        (local-set-key (kbd "<f3> t") 'stampede-compile-tests)
...
#+BEGIN_SRC emacs-lisp
    ...
    (add-hook 'c++-mode-hook
              (function (lambda ()
                          (local-set-key (kbd "<f4> t") 'stardust-compile-tests)
...
#+BEGIN_SRC emacs-lisp
    ...
    (add-hook 'c++-mode-hook
              (function (lambda ()
                          (local-set-key (kbd "<f5> t") 'blackhole-compile-tests)
